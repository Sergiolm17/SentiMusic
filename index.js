...
app.get("/playlist", function (req, res) {
    ...
    if (userid === null || playlist === null)
        sendDataSecundary(
            "https://us-central1-escucharla-app.cloudfunctions.net/loginUser",
            { id: userid, playlist },
            (data) => {
                console.log(data);
            }
          ...
          (body, error) => {
            ...
            if (body) {
              ...
              sendData(
                ...
                access_token,
                "https://us-central1-escucharla-app.cloudfunctions.net/savedTracks",
                body,
                function(body, err) {},
                { limit: 10 },
                function(body, err) {}
            ...
            sendDataSecundary(
              "https://us-central1-escucharla-app.cloudfunctions.net/getPlaylist",
              body,
              receive => {
